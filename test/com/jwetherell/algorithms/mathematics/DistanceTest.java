...
class DistanceTest {
    ...
    void chebyshevDistance() {
        assertEquals(5, chebyshevDistance(new int[]{1, 2}, new int[]{4, 5})); // Regular case
        assertEquals(0, chebyshevDistance(new int[]{1, 1}, new int[]{1, 1})); // Same points
    ...
    void squaredDistance() {
        ...
        assertEquals(0, squaredDistance(new int[]{0, 0}, new int[]{0, 0}));
        assertEquals(200, squaredDistance(new int[]{-5, 3}, new int[]{5, -7}));
    ...
    void euclideanDistance() {
        ...
        assertEquals(14.142, euclideanDistance(new int[]{-5, 3}, new int[]{5, -7}), 0.001);
